...
this module does not require it. Install nilearn (and nibabel) to use the parcellation path.
"""
...
def parcellate(func_img: Any, atlas_img: Any, confounds: Any = None, **masker_kwargs: Any) -> np.ndarray:
    ...
    **masker_kwargs
    ...
    try:
        ...
        msg = "fMRI parcellation requires nilearn. Install it with: pip install nilearn"
