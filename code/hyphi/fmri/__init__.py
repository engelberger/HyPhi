...
standard atlases) is delegated to nilearn, an optional dependency imported lazily; the
correlation and partial-correlation connectivity use only NumPy. Import on demand
(``import hyphi.fmri``).
"""
